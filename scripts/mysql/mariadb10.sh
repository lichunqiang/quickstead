...
# 检测是否需要安装
if [ -f /home/vagrant/.env/mariadb10 ]
then
    exit 0
fi
...
# 安装 MariaDB
yum install -y mariadb-server maraidb-client mariadb-devel mariadb-common --enablerepo=mariadb-10

# 建立 环境标识
rm -rf /home/vagrant/.env/mysql*
rm -rf /home/vagrant/.env/mariadb*
touch /home/vagrant/.env/mariadb10
